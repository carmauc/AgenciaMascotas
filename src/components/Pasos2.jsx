...
import Recurso from './Recurso 1.svg'
function Pasos() {
  return (
    <section class="relative overflow-hidden bg-teal-500 ">
    <div class="mt-2 md:mt-0 py-12 pb-6 sm:py-16 lg:pb-24 overflow-hidden">
        <div class="px-4 mx-auto max-w-8xl sm:px-6 lg:px-8 relative">
                ...
                <div class="absolute inset-x-0 hidden xl:px-44 top-2 md:block md:px-20 lg:px-28">
                    <svg class="w-full" xmlns="http://www.w3.org/2000/svg" width="875" height="48" viewBox="0 0 875 48"
                        ...
                        <path
                            ...
                            stroke="#D4D4D8" stroke-width="4" stroke-linecap="round" stroke-dasharray="1 12" />
                    </svg>
