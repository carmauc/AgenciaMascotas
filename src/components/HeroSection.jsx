...
const HeroSection = () => {
  ...
  const slides = [
    {
      image: 'https://res.cloudinary.com/dmurguugh/image/upload/f_auto,q_auto/v1/Agencia%20de%20Viajes/bfj6clpi7fnit6hg13hw',
      title: `${t('description')}`,
      subtitle: "Rewriting sport's playbook for billions of athletes",
      link: '#',
    },
    {
      image: 'https://res.cloudinary.com/dmurguugh/image/upload/f_auto,q_auto/v1/Agencia%20de%20Viajes/l3fg4kd99fo0kvynttsw',
  ...
  return (
    <section className="pt-16 bg-[url(/background.svg)] bg-cover">
    <div className="">
      <div className="relative">
        <div className="relative overflow-hidden w-full h-[30rem] md:h-[calc(100vh-106px)] bg-gray-100 dark:bg-neutral-800 ">
          <div className="flex transition-transform duration-700" style={{ transform: `translateX(-${currentSlide * 100}%)` }}>
            {slides.map((slide, index) => (
              <div className="flex-shrink-0 w-full" key={index}>
                <div className="h-[30rem] md:h-[calc(100vh-106px)] flex flex-col bg-cover bg-center bg-no-repeat box-content" style={{ backgroundImage: `url(${slide.image})` }}>
                  <div className="mt-auto w-2/3 md:max-w-lg p-5 md:p-10">
                    ...
                    <div className="mt-5 mb-10">
                      <a className="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-xl bg-white border border-transparent text-black hover:bg-gray-100 disabled:opacity-50 disabled:pointer-events-none" href={slide.link}>
                        Contactanos
                      </a>
                    </div>
...
{/* 
    ...
    <div class="max-w-5xl px-4 xl:px-0 mx-auto">
      ...
      <div class="flex justify-between gap-6">
        ...
        <button
          type="button"
          className="absolute inset-y-0 left-0 flex justify-center items-center w-12 h-full text-black hover:bg-white/20 rounded-s-2xl focus:outline-none focus:bg-white/20"
          onClick={prevSlide}
        >
        ...
        <button
          type="button"
          className="absolute inset-y-0 right-0 flex justify-center items-center w-12 h-full text-black hover:bg-white/20 rounded-e-2xl focus:outline-none focus:bg-white/20"
          onClick={nextSlide}
        >
