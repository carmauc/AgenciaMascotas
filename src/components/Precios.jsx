  ...
  return (
    ...
    <div class="container px-6 py-8 mx-auto">
        <div class="xl:items-center xl:-mx-8 xl:flex">
            <div class="flex flex-col items-center xl:items-start xl:mx-20">
                <h1 class="text-2xl font-medium capitalize lg:text-3xl text-white">Nuestros Precios</h1>
                ...
                Vas a viajar con tu perro o gato en avión.<br/>MascoFly ofrece paquetes a un precio fijo.
                </p>

                <a href="#" class="flex items-center mt-4 -mx-1 text-sm text-gray-700 capitalize dark:text-teal-400 hover:underline hover:text-teal-600 dark:hover:text-teal-500">
            ...
            <div class="flex-1 xl:mx-8">
                <div class="mt-8 space-y-8 md:-mx-4 md:flex md:items-center md:justify-center md:space-y-0 xl:mt-0">
                    <div class="max-w-sm mx-auto border rounded-lg md:mx-4 dark:border-gray-700 bg-gray-700">
                        <div class="p-6">
                            ...
                            <button class="w-full px-4 py-2 mt-6 tracking-wide text-white capitalize transition-colors duration-300 transform bg-teal-600 rounded-md hover:bg-teal-500 focus:outline-none focus:bg-teal-500 focus:ring focus:ring-teal-300 focus:ring-opacity-80">
                                Start Now
                            </button>
                        </div>
