...
const Carrusel3 = () => {
  ...
  const [selectedTab, setSelectedTab] = useState('tabs-with-card-1');
...
<div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
  ...
  <button
            ...
            className={`hs-tab-active:bg-white hs-tab-active:shadow-md hs-tab-active:hover:border-transparent text-start hover:bg-gray-200 p-4 md:p-5 rounded-xl dark:hs-tab-active:bg-slate-900 dark:hover:bg-gray-700 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600 ${
              selectedTab === 'tabs-with-card-1' && 'hs-tab-active:bg-blue-200'
            }`}
          ...
          >   
                   <span className="flex">
              <svg className="flex-shrink-0 mt-2 size-6 md:size-7 hs-tab-active:text-blue-600 text-gray-800 dark:hs-tab-active:text-blue-500 dark:text-gray-200" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 5.5A3.5 3.5 0 0 1 8.5 2H12v7H8.5A3.5 3.5 0 0 1 5 5.5z"/><path d="M12 2h3.5a3.5 3.5 0 1 1 0 7H12V2z"/><path d="M12 12.5a3.5 3.5 0 1 1 7 0 3.5 3.5 0 1 1-7 0z"/><path d="M5 19.5A3.5 3.5 0 0 1 8.5 16H12v3.5a3.5 3.5 0 1 1-7 0z"/><path d="M5 12.5A3.5 3.5 0 0 1 8.5 9H12v7H8.5A3.5 3.5 0 0 1 5 12.5z"/></svg>
          ...
          <button
            type="button"
            className={`hs-tab-active:bg-white hs-tab-active:shadow-md hs-tab-active:hover:border-transparent text-start hover:bg-gray-200 p-4 md:p-5 rounded-xl dark:hs-tab-active:bg-slate-900 dark:hover:bg-gray-700 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600 ${
              selectedTab === 'tabs-with-card-2' && 'hs-tab-active:bg-blue-200'
            }`}
          ...
          <button
            type="button" className={`hs-tab-active:bg-white hs-tab-active:shadow-md hs-tab-active:hover:border-transparent text-start hover:bg-gray-200 p-4 md:p-5 rounded-xl dark:hs-tab-active:bg-slate-900 dark:hover:bg-gray-700 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600 ${
              selectedTab === 'tabs-with-card-3' && 'hs-tab-active:bg-blue-200'
            }`}
      ...
      <div className="lg:col-span-6">
        <div className="relative">
          <div>
            <div id="tabs-with-card-1" role="tabpanel" aria-labelledby="tabs-with-card-item-1" className={`${selectedTab === 'tabs-with-card-1' ? 'block' : 'hidden'}`}
>
            ...
            <div id="tabs-with-card-2" className={`${selectedTab === 'tabs-with-card-2' ? 'block' : 'hidden'}`}role="tabpanel" aria-labelledby="tabs-with-card-item-2">
            ...
            <div id="tabs-with-card-3" className={`${selectedTab === 'tabs-with-card-3' ? 'block' : 'hidden'}`} role="tabpanel" aria-labelledby="tabs-with-card-item-3">
